...
2. Codex classifies direct relevance and writes short English and Chinese summaries.
3. Deterministic scripts restore titles, authors, dates, paper URLs, and DOI values from the original arXiv evidence.
4. Only high-confidence records that pass the schema and unit tests are proposed in a pull request.
